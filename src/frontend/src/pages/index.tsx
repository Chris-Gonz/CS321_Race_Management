...
export default function Home() {
	...
	const socketInitializer = async () => {
		...
		socket.on("get-toggle-time", (toggle: String) => {
			setIsRunning(toggle === "true");
			...
			<div className="flex flex-col items-center justify-center h-full">
				...
				<div className="h-full w-[95%] flex justify-center items-center">
					{Cars.map((Cars, i) => (
						<div
							key={i}
							className="flex flex-col items-center w-full h-full gap-3 mx-9"
						>
				...
				<div className="flex flex-col items-center justify-center w-full h-full gap-3">
					...
					<div className="absolute flex flex-row justify-between w-3/5">
						{Cars.map((Cars, i) => (
							<div
								key={i}
								className="flex flex-row justify-center p-8 bg-gray-800 rounded-3xl"
							>
